...
public class UserProfile extends AppCompatActivity {
    ...
    private ImageView ivProfile;    //declaration
    ...
    private void updateOnlyName()
    {
        ...
        user.updateProfile(request).addOnCompleteListener(this, new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                {
                    Toast.makeText(UserProfile.this, "task is succesful", Toast.LENGTH_SHORT).show();
                }
                else
                    Toast.makeText(UserProfile.this, "Failed to update profile"
    ...
    {
        mAuth.signOut();
        startActivity( new Intent(UserProfile.this,Student_login.class));
        finishAffinity();
    }
}